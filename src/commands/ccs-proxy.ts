...
function formatProxyHistoryRequest(record: ProxyRequestRecord, index: number): TableRow {
...
function formatProxyActiveRequest(record: ProxyActiveRequestRecord, nowMs: number, index: number): TableRow {
