...
import { assertProfile, readProfiles, type Profile } from "../lib/profiles.js";
...
export async function resolveCodexProfileLaunch(name: string): Promise<CodexProfileLaunch> {
