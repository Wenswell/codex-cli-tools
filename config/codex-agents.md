...
- 等待SubAgent完成的时间延长，简单任务至少等待3分钟，普通任务至少等待5分钟，以此类推

【寻找更优方案】

- 确定性问题按照：第一性原理 + 贝叶斯公式 + 奥卡姆剃刀法则
- 非确定性问题按照：有界贝叶斯 + 相变识别 + 时间成本最优
...
- 文档完备、文档收尾。若项目较小/功能单一，可根据实际情况进行调整
...
- 对于真正的区别，使用平行的肯定句
- 禁止无意义的表达，如禁止 `对，你说的对|我直接把结论说清楚，不绕` 等等无价值无意义的描述
...
- 禁用企业黑话，示例：禁止 `收|根因|收口|落盘|链路|打法|拆薄` 等等黑话词汇
- 禁止拟人化的描述，示例：严禁 `吃 落 打 写死 定死 吃掉 定住 摸清` 等拟人化描述
- 尤其是禁止拟人化描述代码逻辑文档需求等相关内容，用常规描述/动词，禁止拟人
